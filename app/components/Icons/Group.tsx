export const Group = (props: { width?: number, height?: number }) => {
    return <svg fill="currentcolor" height="61px" width="61px" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" >
